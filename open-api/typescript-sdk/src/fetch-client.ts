...
export type RecentVideoUpdateDto = {
 ...
 * Get time bucket
 */
export function getTimeBucket({ albumId, assetType, bbox, isFavorite, isTrashed, key, order, personId, slug, tagId, timeBucket, userId, visibility, withCoordinates, withPartners, withStacked }: {
    albumId?: string;
 ...
 * Get time buckets
 */
export function getTimeBuckets({ albumId, assetType, bbox, isFavorite, isTrashed, key, order, personId, slug, tagId, userId, visibility, withCoordinates, withPartners, withStacked }: {
    albumId?: string;
    assetType?: AssetTypeEnum;
    bbox?: string;
    isFavorite?: boolean;
 ...
 */
export function getMyRecentVideos(opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 200;
        data: AssetResponseDto[];
    }>("/users/me/recent-videos", {
        ...opts
    }));
}
/**
 * Update my recent videos
 */
export function updateMyRecentVideos({ recentVideoUpdateDto }: {
    recentVideoUpdateDto: RecentVideoUpdateDto;
}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 200;
        data: AssetResponseDto[];
    }>("/users/me/recent-videos", oazapfts.json({
        ...opts,
        method: "PUT",
